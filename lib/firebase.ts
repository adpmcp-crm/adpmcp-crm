...
console.log("Firebase config loaded:", !!firebaseConfigJson);
...
export const db = getFirestore(app, process.env.NEXT_PUBLIC_FIRESTORE_DATABASE_ID || firebaseConfigJson.firestoreDatabaseId);
