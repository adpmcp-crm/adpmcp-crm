    ...
    <div className="space-y-10 pb-20">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h1 className="text-4xl font-black text-gray-900 tracking-tight">Calendário de Actividades 2024</h1>
        ...
        <div className="flex items-center gap-3">
          <button className="px-5 py-3 bg-gray-100 text-gray-600 font-bold rounded-2xl text-sm flex items-center gap-2 hover:bg-gray-200 transition-all active:scale-95">
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="md:col-span-2 bg-blue-600 p-8 rounded-[32px] shadow-xl shadow-blue-100 relative overflow-hidden flex flex-col justify-between text-white">
          <div className="relative z-10">
            ...
            <h3 className="text-2xl font-bold mt-1">Assembleia Geral de 35 Anos</h3>
            <p className="text-blue-100 text-sm mt-1">Agendado para 14-16 de Setembro</p>
          </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 space-y-8">
          <div className="bg-gray-50 p-8 rounded-[40px] border border-gray-100">
            ...
            <div className="space-y-4">
              <div className="p-5 bg-white rounded-3xl shadow-sm hover:translate-y-[-4px] transition-all duration-300 border border-gray-100">
                <div className="w-10 h-10 bg-blue-50 flex items-center justify-center rounded-2xl mb-4 text-blue-600">
                  <Users className="w-5 h-5" />
                </div>
                <h4 className="font-bold text-gray-900">Semana de Avivamento Jovem</h4>
                <p className="text-xs text-gray-500 mt-1">12 - 19 de Junho</p>
                <div className="mt-4 flex justify-between items-center">
                  <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">PLANEAMENTO 80%</span>
              ...
              <div className="p-5 bg-white rounded-3xl shadow-sm hover:translate-y-[-4px] transition-all duration-300 border border-gray-100">
                <div className="w-10 h-10 bg-amber-50 flex items-center justify-center rounded-2xl mb-4 text-amber-600">
                  <Briefcase className="w-5 h-5" />
                </div>
                <h4 className="font-bold text-gray-900">Conferência de Mulheres</h4>
                <p className="text-xs text-gray-500 mt-1">05 - 08 de Outubro</p>
                <div className="mt-4 flex justify-between items-center">
